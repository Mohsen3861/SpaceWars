    ...
    while(fscanf(file, "%s", buf) != EOF) {
        ...
        case 'n':               /* newmtl */
           if( fgets(buf, sizeof(buf), file)!=NULL);
            ...
            break;
        case 'N':
           if( fscanf(file, "%f", &model->materials[nummaterials].shininess)!=0);
        ...
        case 'K':
            ...
            case 'd':
                if(fscanf(file, "%f %f %f",
                    ...
                    &model->materials[nummaterials].diffuse[2])!=0);
                break;
            case 's':
               if( fscanf(file, "%f %f %f",
                    &model->materials[nummaterials].specular[0],
                    &model->materials[nummaterials].specular[1],
                    &model->materials[nummaterials].specular[2])!=0);
                break;
            case 'a':
               if( fscanf(file, "%f %f %f",
                    &model->materials[nummaterials].ambient[0],
                    &model->materials[nummaterials].ambient[1],
                    &model->materials[nummaterials].ambient[2])!=0);
                break;
            default:
                /* eat up rest of line */
               if( fgets(buf, sizeof(buf), file)!=NULL);
...
glmReadPPM(char* filename, int* width, int* height)
{
   ...
   if( fread(image, sizeof(unsigned char), w*h*3, fp)!=0);
    fclose(fp);
